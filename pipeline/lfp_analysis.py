...
#convert_to_mp4(experiment_dir)
paths = {}
session_to_trodes_temp, paths= extract_all_trodes(input_dir, output_dir, TONE_DIN, TONE_STATE)
...
# print all values in first 5 rows
for i in range(5):
